...
export function renderListWithTemplate(  //export function can be imported to other parts of your code
  ...
  list, //this is the array that contains the items that will be rendered
